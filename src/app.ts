...
const MONGODB_URI =
  "mongodb+srv://root:TQ2Uj6YDd8DJNenJ@test-cluster.qfxx9.mongodb.net/steeldb?retryWrites=true&w=majority&appName=test-cluster"
...
mongoose
  ...
  .then(() => {
    httpServer.listen(PORT, parseInt(IP_ADDRESS as string), () => {
